...
$sql ="SELECT * FROM `tblpatients` WHERE  CONCAT(Lname,', ',Fname,' ',Mname) LIKE '%".$Patients."%'";
 $mydb->setQuery($sql);
    ...
    ?>
     ...
     <div class="row " > 
       <div class="table-responsive">   
        <div class="col-md-12  ">
          <table class="table-summary" style="font-size: 12px;width: 100%"> 
            <tr> 
              <td id="summary-name" width="18%">Total</td>
              <td colspan="2" style="text-align: right;"><?php echo $setDefault->default_currency(); ?> <span style="color: red;font-size:12px;"><?php echo number_format($totalamount,2); ?> </span> </td>
            </tr> 
          </table>
        </div> 
       </div>  
 ...
 <div class="row">
  <div class="col-md-12" style="margin-top: 9px">
   ...
   <div class="autocomplete search"> 
      <a href="#" class="btn btn-md btn-primary" data-toggle="modal" data-target="#modalproducts">Add Medicine</a>
   </div>  
   <div id="loadcart">
